...
NEURON {
	POINT_PROCESS AMPActx
	POINTER pre
	RANGE C, R, R0, R1, g, gmax, lastrelease, F, F0, F1
...
PARAMETER {
	...
	f = 0.0 				: 0.1 incremental increase in facilitation (F) with arrival of presyn AP
	Ftau = 50 (ms)			: 50 time constant for decay of F back to 1
	Finf = 1				: F always decays back to 1
}
...
ASSIGNED {
	...
	F0				: facilitation factor at start of release
	F1				: facilitation factor at end of release
