...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 nmdanet /Users/awile/workbench/modldb/nmodldb/models/db/modeldb/114665/mod/nmdanetOB.mod\n");
...
{
 { error =  release();
 if(error){fprintf(stderr,"at line 97 in file nmdanetOB.mod:\n	SOLVE release METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/awile/workbench/modldb/nmodldb/models/db/modeldb/114665/mod/nmdanetOB.mod";
static const char* nmodl_file_text = 
