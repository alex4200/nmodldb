...
#define mvhalf mvhalf_kdr
 double mvhalf = -18;
#define mbaserate mbaserate_kdr
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "k_ion");
 	...
 	ivoc_help("help ?1 kdr /Users/awile/workbench/modldb/nmodldb/models/db/modeldb/7399/mod/kdr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/awile/workbench/modldb/nmodldb/models/db/modeldb/7399/mod/kdr.mod";
static const char* nmodl_file_text = 
  "NEURON { SUFFIX kdr }\n"
  "  \n"
