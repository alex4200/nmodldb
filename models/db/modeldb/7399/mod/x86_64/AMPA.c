...
#define initq initq__AMPA 
#define init_arrays init_arrays__AMPA 
#define prq prq__AMPA 
#define popqh2 popqh2__AMPA 
#define popqh1 popqh1__AMPA 
#define release release__AMPA 
#define setlink setlink__AMPA 
...
#define check check_AMPA
#define code code_AMPA
#define delay delay_AMPA
#define exptable exptable_AMPA
#define getR getR_AMPA
#define getdbx getdbx_AMPA
#define gmax gmax_AMPA
#define link link_AMPA
#define pre pre_AMPA
#define post post_AMPA
...
#define Rinf Rinf_AMPA
 double Rinf = 0;
#define SPKSTORE SPKSTORE_AMPA
 double SPKSTORE = 50;
#define exptemp exptemp_AMPA
 double exptemp = 37;
#define q10 q10_AMPA
 double q10 = 1;
#define usetable usetable_AMPA
 ...
 "GMAX_AMPA", &GMAX_AMPA,
 "DELAY_AMPA", &DELAY_AMPA,
 "SPKSTORE_AMPA", &SPKSTORE_AMPA,
 "CHAINLEN_AMPA", &CHAINLEN_AMPA,
 "q10_AMPA", &q10_AMPA,
 "exptemp_AMPA", &exptemp_AMPA,
 "Rinf_AMPA", &Rinf_AMPA,
 "Rtau_AMPA", &Rtau_AMPA,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 AMPA /Users/awile/workbench/modldb/nmodldb/models/db/modeldb/7399/mod/AMPA.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/awile/workbench/modldb/nmodldb/models/db/modeldb/7399/mod/AMPA.mod";
static const char* nmodl_file_text = 
